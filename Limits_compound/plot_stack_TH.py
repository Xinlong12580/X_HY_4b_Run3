...
f_name="Templates/Templates_All1p1_all.root"
save_dir = "test_fit"
#######################################################################################################################
...
for region in regions:
    for year in years:
        h_BKGs_rebinned_projx_merged[region][year]["MC_QCDJets"] = h_BKGs_rebinned_projx_merged[region][year]["MC_TTBarJets"].Clone("xQCD")
        h_BKGs_rebinned_projx_merged[region][year]["MC_QCDJets"].Reset()
        h_BKGs_rebinned_projy_merged[region][year]["MC_QCDJets"] = h_BKGs_rebinned_projy_merged[region][year]["MC_TTBarJets"].Clone("yQCD")
