work=$1
if [[ $work == skim ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_skim.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_skim/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == selection_1p1 ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_selection_1p1.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_selection_1p1/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == Nminus1_1p1 ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_Nminus1_1p1.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_Nminus1_1p1/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == division_1p1 ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_division_1p1.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_division_1p1/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == selection_2p1 ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_selection_2p1.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_selection_2p1/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == Nminus1_2p1 ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_Nminus1_2p1.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_Nminus1_2p1/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == division_2p1 ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_division_2p1.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_division_2p1/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == skim_a ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_skim.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/tmp/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == selection_2p1_debug ]] ; then
    sed -e 's/PYTHON_SCRIPT/run_selection_2p1_debug.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_selection_2p1_debug/#g' gridrun_template.sh > gridrun.sh
...
if [[ $work == mass_debug_2p1 ]] ; then
    ...
    sed -e 's/PYTHON_SCRIPT/run_mass_debug_2p1.py/g' -e 's#OUTPUT_DIR#root://cmseos.fnal.gov//store/user/$USER/XHY4bRun3_mass_debug_2p1/#g' gridrun_template.sh > gridrun.sh
