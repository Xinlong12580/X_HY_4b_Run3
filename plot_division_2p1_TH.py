...
with open("hists_division_2p1_TH.pkl", "rb") as f:
    hists = pickle.load(f)
...
# Fill the 2D array of contents
        ...
        fig_data.savefig(f"plots_division_2p1/{year}__data__{region}.png")
        ...
        fig_ttbar.savefig(f"plots_division_2p1/{year}__ttbar__{region}.png")
        ...
        fig_netQCD.savefig(f"plots_division_2p1/{year}__netQCD__{region}.png")
...
for region in h_data_all:
    ...
    ax.set_ylabel("MJJ")
    plt.tight_layout()
    plt.savefig(f"plots_division_2p1/ALL__data__{region}.png")
    ...
    ax_netQCD.set_ylabel("MJJ")
    fig_netQCD.tight_layout()
    fig_netQCD.savefig(f"plots_division_2p1/ALL__netQCD__{region}.png")
