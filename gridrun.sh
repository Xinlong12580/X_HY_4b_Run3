...
# MAIN FUNCTION
echo python run_Nminus1_1p1.py $* | tee -a $root_dir/out.txt
python run_Nminus1_1p1.py $* | tee -a $root_dir/out.txt
ls | tee -a $root_dir/out.txt
...
xrdcp -f $root_dir/out.txt root://cmseos.fnal.gov//store/user/xinlong/XHY4bRun3_Nminus1_1p1/
